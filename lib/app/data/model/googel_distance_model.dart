...
//
//     final googelDistanceModel = googelDistanceModelFromJson(jsonString);

import 'dart:convert';

GoogelDistanceModel googelDistanceModelFromJson(String str) => GoogelDistanceModel.fromJson(json.decode(str));

String googelDistanceModelToJson(GoogelDistanceModel data) => json.encode(data.toJson());

class GoogelDistanceModel {
    GoogelDistanceModel({
    ...
    factory GoogelDistanceModel.fromJson(Map<String, dynamic> json) => GoogelDistanceModel(
